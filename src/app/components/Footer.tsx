...
export default function Footer() {
  return (
    <footer className="bg-black/50 backdrop-blur-sm border-t border-green-400/20 mt-auto">
      <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-green-400/20 mt-8 pt-6">
          ...
          {/* Call to Action */}
          <div className="text-center mt-6 p-4 bg-green-800/30 rounded-lg border border-green-400/20">
            <p className="text-green-200 text-sm mb-2">
              Ready to join our premium cannabis community?
            </p>
            <a 
              href="https://t.me/GBShopXBot" 
              target="_blank" 
              rel="noopener noreferrer"
              className="inline-flex items-center px-6 py-2 bg-green-600 hover:bg-green-700 text-white text-sm font-medium rounded-lg transition-colors"
            >
