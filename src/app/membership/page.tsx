    ...
    return (
      <div className="text-center py-8">
        ...
        <p className="text-green-300 mb-6">
          Your {selectedTier} membership has been created! Check your email for confirmation and login to access your membership dashboard.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Link 
            href="/management"
            className="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-full font-semibold transition-colors flex items-center space-x-2"
          >
